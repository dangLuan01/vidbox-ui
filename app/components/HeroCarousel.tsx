                ...
                <div className="mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8">
                  ...
                  <div className="mt-4">
                    ...
                    <Link href={`/${movie.media_type}/${movie.id}`}>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-info pr-1"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
                        See More
                      </button>
                    </Link>
                  </div>
